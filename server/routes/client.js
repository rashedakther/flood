...
router.post(
  ...
  function(req, res, next) {
    client.addFiles(req.user, req, ajaxUtil.getResponseFn(res));
  }
);

router.get('/settings', function(req, res, next) {
  client.getSettings(req.user, req.query, ajaxUtil.getResponseFn(res));
});

router.patch('/settings', function(req, res, next) {
  client.setSettings(req.user, req.body, ajaxUtil.getResponseFn(res));
});

router.put('/settings/speed-limits', function(req, res, next) {
  client.setSpeedLimits(req.user, req.body, ajaxUtil.getResponseFn(res));
});

router.post('/start', function(req, res, next) {
  client.startTorrent(req.user, req.body.hashes, ajaxUtil.getResponseFn(res));
});

router.post('/stop', function(req, res, next) {
  client.stopTorrent(req.user, req.body.hashes, ajaxUtil.getResponseFn(res));
});

router.post('/torrent-details', function(req, res, next) {
  client.getTorrentDetails(req.user, req.body.hash, ajaxUtil.getResponseFn(res));
});

router.patch('/torrents/:hash/priority', function(req, res, next) {
  client.setPriority(req.user, req.params.hash, req.body, ajaxUtil.getResponseFn(res));
});

router.patch('/torrents/:hash/file-priority', function(req, res, next) {
  client.setFilePriority(req.user, req.params.hash, req.body, ajaxUtil.getResponseFn(res));
});

router.post('/torrents/check-hash', function(req, res, next) {
  client.checkHash(req.user, req.body.hash, ajaxUtil.getResponseFn(res));
});

router.post('/torrents/move', function(req, res, next) {
  client.moveTorrents(req.user, req.body, ajaxUtil.getResponseFn(res));
});
...
router.get('/methods.json', function(req, res, next) {
  ...
  client.listMethods(req.user, method, args, ajaxUtil.getResponseFn(res));
});
